...
gulp.task('scripts', function () {
	return gulp.src([
		...
		'app/js/libs.js', // JS libraries (all in one)
		//'app/js/_copy.js', // JS libraries (all in one)
		'app/js/custom.js', // Custom scripts. Always at the end
	])
